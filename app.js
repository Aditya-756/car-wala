...
function renderTrack() {
  ...
  if (state.started) document.title = `${t.title} — कार वाला`;
...
/* ── Bumper lines ────────────────────────────────────────────
   Safar lines for the car version: warnings, blessings,
   goodbyes, and the odd bit of showing off.
   ──────────────────────────────────────────────────────────── */

const BUMPER_LINES = [
  'सफर सुहाना हो',
  'कार वाला दिलदार',
  'धीरे चलो, मंज़िल भी मिलेगी और सुकून भी',
  'रफ्तार कम, अंदाज़ ज़्यादा',
  'सीट बेल्ट लगाओ, मुस्कुराते जाओ',
  'मेरा सफर, मेरी कार',
  'दिल्ली अभी दूर है',
  'मंज़िल से प्यारा ये रास्ता',
  'रब राखा, सफर चंगा',
  'जय माता दी, सफर सुरक्षित रहे',
  'साइड दीजिए, कार आ रही है',
  'चलती का नाम कार',
  'हवा से बातें नहीं, दिल से बातें',
  'धीरे चल प्यारे, जीवन अनमोल है',
  'घर पर कोई इंतज़ार कर रहा है',
  'यारों के साथ सफर यादगार',
  'रास्ते लंबे हों, गाने पुराने हों',
  'कार छोटी सही, सपने बड़े हैं',
  'बुरी नज़र वाले, तेरा भी भला हो',
  'नज़र प्यार की रखना, रफ्तार समझदारी की',
  'तेरा साथ हो तो हर सड़क अपनी है',
  'म्यूज़िक ऑन, टेंशन ऑफ',
  'लॉन्ग ड्राइव और पुराने गाने',
  'रात जवान, सड़क मेहरबान',
  'शहर छूटा, दिल खुला',
  'जहां दिल ले जाए, वहीं रास्ता',
  'सावधानी हटी, दुर्घटना घटी',
  'ओवरटेक सोच समझ कर',
  'धैर्य रखो, रास्ता सबको मिलता है',
  'मां का आशीर्वाद, कार की रफ्तार',
  'पेट्रोल कम हो सकता है, जज़्बा नहीं',
  'राहों का राजा, कार वाला',
  'आज ड्राइव लंबी है, मूड फिल्मी है',
  'सफर में दोस्त हों तो दूरी कम लगती है',
  'कार में गाना, दिल में अफसाना',
  'आगे रास्ता है, पीछे कहानी',
  'इश्क भी सफर है, मंज़िल नहीं',
  'दिल की सड़क पर धीरे चलना',
  'धूल उड़े तो उड़ने दो, सफर चलने दो',
  'किस्तों पे आई है, शान से चलाई है',
  'ना जल्दी, ना टेंशन, बस सफर',
  'खिड़की खुली, यादें चलीं',
  'गाड़ी अपनी, रास्ता अपना',
  'कभी शहर, कभी हाईवे',
  'कार चले तो दिल भी गाए',
  'मंज़िल मिले न मिले, सफर प्यारा है',
  'पुराने गाने, नई यादें',
  'रास्तों से दोस्ती रखो',
  'दिल से चलो, दूर तक चलो',
  'हर मोड़ पर नई कहानी',
  'कार वाला आया, धुन साथ लाया',
  'सफर जारी है',
];
